  ...
  return (
    <Layout>
      <header className="relative h-[40vh] min-h-[300px] flex items-center justify-center overflow-hidden">
        ...
        <img src="/assets/images/bedroom.png" alt="Heritage Modern" className="absolute inset-0 w-full h-full object-cover object-center animate-pulse-slow" />
      ...
      <main className="py-24 px-5 md:px-16 max-w-[800px] mx-auto min-h-[40vh]">
        <div className="prose prose-lg mx-auto font-body-md text-on-surface-variant animate-fade-in-up-delay-2">
          <p className="mb-6">
            Welcome to the Heritage Modern page. This section provides detailed information about our premium offerings and philosophy.
